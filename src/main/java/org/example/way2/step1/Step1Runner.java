package org.example.way2.step1;

import org.example.way2.step1.entity.User;
import org.example.way2.step1.entity.clients.Client;
import org.example.way2.step1.entity.employees.Developer;
...
public class Step1Runner {
    public static void main(String[] args) {
        ...
        // ДОБАВИЛ АННОТАЦИЮ @Inheritance(strategy = InheritanceType.SINGLE_TABLE) В САМЫЙ ВЕРХНИЙ КЛАСС
        // ВСЕ СОХРАНЯЮТСЯ В ОДНУ ОБЩУЮ ТАБЛИЦУ
...
//        }
        ...
        try (Session session = sessionFactory.openSession()){
            Query<User> from_user_ = session.createQuery("from User ", User.class);
